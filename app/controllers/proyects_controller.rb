class ProyectsController < ApplicationController
    ...
    def update
      @proyect.update(name: params[:proyect][:name], description: params[:proyect][:description], state: params[:proyect][:state], initial_date: params[:proyect][:initial_date], finish_date: params[:proyect][:finish_date])
